...
class Distributor:
    def __init__(self):
        self.server = mqtt.Client(callback_api_version=mqtt.CallbackAPIVersion.VERSION2, client_id="RaspberryPiPublisher")
    ...
    def distribute_data(self, data):
        try:
            if data:
                ...
                self.server.publish(MQTT_TOPIC, payload, qos=1, retain=False)
